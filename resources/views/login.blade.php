...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Self-teach-Lab login page </title>
...
<div class="page-wraper">
	...
	<div class="account-form">
		<div class="account-head" style="background-image:url(images/background/bg2.jpg);">
		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					...
					<p>Don't have an account? <a href="registration">Create one here</a></p>
				</div>	
				<form class="contact-bx" action="{{ 'homepage' }}"method="get">
