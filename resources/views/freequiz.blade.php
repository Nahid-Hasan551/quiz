            ...
            <div class="col-md-3 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('freequiz/1') }}" id="myBtn"
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <div class="question-section">
                ...
                <div id="qst-1" class="quiz-questions show questions">
                            ...
                            <tbody>
                                <tr class="table-active">
                                    <td><input type="radio" name="question" id="option1">
                                        <label for="option1">{{ $value->first_option }}</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><input type="radio" name="question" id="option2">
                                        <label for="option2">{{ $value->secound_option }}</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><input type="radio" name="question" id="option3">
                                        <label for="option3">{{ $value->third_option }}</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input type="radio" name="question" id="option4">
                                        <label for="option4">{{ $value->fourth_option }}</label>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
